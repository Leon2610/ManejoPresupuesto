...
namespace ManejoPresupuesto.Controllers
{
    public class CuentasController : Controller
    {
        ...
        public async Task<IActionResult> Detalle(int id, int mes, int year)
        {
            ...
            var modelo = await serviciosReportes.ObtenerReporteTransaccionesDetalladasPorCuenta(usuarioId, id, mes, year, ViewBag);
        ...
        public async Task<IActionResult> Borrar(int id)
        {
            ...
            var cuenta = await repositorioCuentas.ObtenerPorId(id, usuario);
